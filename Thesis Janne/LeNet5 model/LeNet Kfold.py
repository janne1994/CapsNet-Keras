...
for j, (train_idx, val_idx) in enumerate(folds,1):
    ...
    model.save('Lenet_model_'+ str(j) + '.h5')
...
modelfold1 = load_model('Lenet_model_1.h5')
modelfold2 = load_model('Lenet_model_2.h5')
modelfold3 = load_model('Lenet_model_3.h5')
modelfold4 = load_model('Lenet_model_4.h5')
modelfold5 = load_model('Lenet_model_5.h5')
