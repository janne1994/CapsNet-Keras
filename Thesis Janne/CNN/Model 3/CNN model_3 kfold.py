...
def model_3():
  ...
  model.add(layers.Conv2D(64, (4,4), activation = 'relu', name = 'conv4')) #added2
  model.add(layers.MaxPooling2D((2, 2), name = 'maxpool4')) #added2
...
for j, (train_idx, val_idx) in enumerate(folds,1):
    ...
    model.save('Model_3_fold_'+ str(j) + '.h5')
...
modelfold1 = load_model('Model_3_fold_1.h5')
modelfold2 = load_model('Model_3_fold_2.h5')
modelfold3 = load_model('Model_3_fold_3.h5')
modelfold4 = load_model('Model_3_fold_4.h5')
modelfold5 = load_model('Model_3_fold_5.h5')
