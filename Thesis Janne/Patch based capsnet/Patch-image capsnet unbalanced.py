...
x_train_patches = x_train.reshape((41451, 14, 14 ,1))
x_test_patches = x_test.reshape((12954, 14, 14 ,1))
x_val_patches = x_val.reshape((10363, 14, 14 ,1))
...
model.save_weights('capsnet_patches_final__imb_7jan.h5')
